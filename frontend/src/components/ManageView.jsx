      ...
      <div className="admin-dashboard card-panel">
        <aside className="admin-sidebar">
          ...
          <nav className="admin-nav">
            <button type="button" className="admin-nav__item active">Tong quan</button>
            <button type="button" className="admin-nav__item">Nguoi dung</button>
            <button type="button" className="admin-nav__item">Kiem duyet</button>
            <button type="button" className="admin-nav__item">Noi dung</button>
            <button type="button" className="admin-nav__item">Bao cao</button>
            <button type="button" className="admin-nav__item">Cai dat</button>
          </nav>
